...
(function ($, window, document) {
    ...
    const onTabChangeRefreshPositionOfCarousel = function () {
        ...
        // Specificity = 2
        $('.section-maker [data-toggle="tab"]').on(
            "shown.bs.tab",
            function (e) {
...
(function ($, window, document, undefined) {
            ...
            $(".price-filter").slider({
                ...
                slide: function (event, ui) {
                    let result =
                        '<div value="' +
                        ui.values[0] +
                        '" class="price-from" id="price-min">' +
                        currecyUnit +
                        ui.values[0] +
                        '</div>\n<div value="' +
                        ui.values[1] +
                        '" class="price-to" id="price-max">' +
                        currecyUnit +
                        ui.values[1] +
                        "</div>\n";
    ...
    const attachClickGridAndList = function () {
        $(document).on("click", "#list-anchor", function (event) {
            let $shopProductContainer = $(".product-container");
            event.preventDefault();
            $("#list-anchor").addClass("active");
            $("#list-anchor").next().removeClass("active");
            $shopProductContainer.removeClass("grid-style");
            $shopProductContainer.addClass("list-style");
        });
        $(document).on("click", "#grid-anchor", function (event) {
            let $shopProductContainer = $(".product-container");
            event.preventDefault();
            $("#grid-anchor").addClass("active");
            $("#grid-anchor").prev().removeClass("active");
