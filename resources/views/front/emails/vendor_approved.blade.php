            ...
            >
              <tbody>
                ...
                <tr>
                  <td style="text-align: center; padding: 0 30px 20px">
                    ...
                    <p style="margin-bottom: 5px">
                      Your Vendor Account has been approved.<br />
                ...
                <tr>
                    <td style="text-align: center; padding: 0 30px 20px">
                        <br>
                        Now You can start selling Your products in myCommerce Admin Panel under Catalogue Management page.
                        <br>
                        <br>
                        <a
                        ...
                        <br>
                        <br>
                       <p style="margin-bottom: 10px">Thank You for choosing myCommerce and We hope You can make a fortune.</p><br>
                    <hr style="opacity: 30%" />
                    </td>
                </tr>
                <tr>
