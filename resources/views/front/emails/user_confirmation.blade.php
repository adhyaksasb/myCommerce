                ...
                <tr>
                  <td style="padding: 0 30px 20px">
                    ...
                    <p style="margin-bottom: 10px">
                      Welcome! <br />
                      We're happy you signed up for myCommerce as a User.
                      <br />
                    </p>
                    <p style="margin-bottom: 10px">
                      To use the full range of services with your account, please verify your email address.
                    </p>
                    <p style="margin-bottom: 25px">
                      You can click on the button below to verify your user
                      account :
                    </p>
                    <a
                      href="{{ url('user/confirm/'.$code) }}"
                      style="
