              ...
              <tbody>
                ...
                <tr>
                  <td style="padding: 0 30px 20px">
                    <p style="color:black; margin-bottom: 10px">
                      Welcome! <br />
                      We need to confirm your login attempt.
                      <br />
                    </p>
                    <p style="color:black; margin-bottom: 25px">
                      You can input below code, and please do not share this code to everyone including myCommerce team. The code will be expired after 3 minutes.
                    </p>
                ...
                <tr>
                    <td style="padding: 20px 30px">
                      <p style="color:black; margin-top: 20px"><b>myCommerce Team</b></p>
                      <br />
                      <hr style="opacity: 30%" />
                    </td>
                  </tr>
