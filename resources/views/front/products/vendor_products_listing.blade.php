...
<div class="row product-container grid-style">
    @foreach($vendorProducts as $product)
        @php 
            $productUrl = strtolower(str_replace([' ','&','/'], '-', $product['product_name']));
            $colorUrl =  strtolower(str_replace([' ','&','/'], '-', $product['product_color']));
    ...
    <div class="product-item col-lg-3 col-md-6 col-sm-6">
        <div class="item">
            <div class="image-container">
                <a class="item-img-wrapper-link" href="{{url('/'.$brandUrl.'-'.$productUrl.'-'.$colorUrl.'/'.$product['id'])}}">
            ...
            <div class="item-content">
                <div class="what-product-is">
                    ...
                    <h6 class="item-title">
                        <a href="{{url('/'.$brandUrl.'-'.$productUrl.'-'.$colorUrl.'/'.$product['id'])}}">{{ $product['product_name'] }}</a>
                    </h6>
...
<div class="pagination-area">
    {{ $vendorProducts->appends(['sort'=>$_GET['sort']])->links('front.products.pagination') }}
</div>
@else
<div class="pagination-area">
    {{ $vendorProducts->links('front.products.pagination') }}
</div>
@endif
<!-- Shop-Pagination /- -->