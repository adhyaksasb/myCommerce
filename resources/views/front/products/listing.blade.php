    ...
    <div class="page-style-a">
        <div class="container">
            <div class="page-intro">
                <h2>{{ucwords($productDetails['categoryName'])}}</h2>
                <ul class="bread-crumb">
                    <li class="has-separator">
                        <i class="ion ion-md-home"></i>
                        <a href="{{url('/')}}">Home</a>
                    </li>
                    @if($productDetails['categoryParent']=="main")
                    <li class="is-marked">
                        <a href="{{url('c/'.$productDetails['sectionUrl'])}}">{{ucwords($productDetails['categoryName'])}}</a>
                    </li>
                    @elseif($productDetails['categoryParent']==0)
                    <li class="has-separator">
                        <a href="{{url('c/'.$productDetails['sectionUrl'])}}">{{ucwords($productDetails['sectionUrl'])}}</a>
                    </li>
                    <li class="is-marked">
                        <a href="{{url('c/'.$productDetails['categoryDetails']['url'])}}">{{ucwords($productDetails['categoryName'])}}</a>
                    </li>
                    @else
                    <li class="has-separator">
                        <a href="{{url('c/'.$productDetails['sectionUrl'])}}">{{ucwords($productDetails['sectionUrl'])}}</a>
                    ...
                    <li class="has-separator">
                        <a href="{{url('c/'.$productDetails['categoryDetails']['parent_category']['url'])}}">{{ucwords($productDetails['categoryDetails']['parent_category']['category_name'])}}</a>
                    </li>
                    <li class="is-marked">
                        <a href="{{url('c/'.$productDetails['categoryDetails']['url'])}}">{{ucwords($productDetails['categoryName'])}}</a>
                    </li>
                        ...
                        <div class="toolbar-sorter-2">
                            <div class="select-box-wrapper">
                                ...
                                <select class="select-box" id="show-records">
                                    <option selected="selected" value="">Showing: {{ count($productListing) }}</option>
