...
<div class="modal-dialog modal-dialog-centered">
    ...
    <button
        type="button"
        class="button dismiss-button ion ion-ios-close"
        data-dismiss="modal"
    ></button>
    <div class="modal-body u-s-p-x-0">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 u-s-p-x-0">
            ...
            <a
                target="_blank"
                rel="nofollow"
                href="https://youtube.com/@adhyaksasb"
                class="banner-hover effect-dark-opacity"
            >
                <img
                class="img-fluid"
                src="{{ asset('front/images/banners/subscribe.png') }}"
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <h1>
                New to <span>myCommerce</span> ? <br />Subscribe to
                our Newsletter
            </h1>
            ...
            <form>
                ...
                <input
                    type="text"
                    class="newsletter-textfield"
                    placeholder="Enter Your Email"
                />
                </div>
                <div class="u-s-m-b-35">
                <button class="button button-primary d-block w-100">
                    Subscribe
                </button>
                </div>
            </form>
...
<div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal-body">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div
                class="section-6-social-media-quantity-actions u-s-p-y-14"
            >
                ...
                <div>
                    ...
                    ></button>
                    <button
                    class="button button-outline-secondary far fa-envelope u-s-m-l-6"
                    ></button>
                </div>
                </form>
            </div>
